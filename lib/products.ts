...
export const PRODUCTS: readonly ProductItem[] = [
  {
    ...
    taglineZh: "为精品咖啡爱好者与数字游民找好咖啡馆、看办公友好度，三秒签到且无广告打扰。",
    taglineEn: "Find specialty coffee and laptop-friendly cafes with 3-second check-in and zero ads.",
    statusCode: "in_development",
    statusStampZh: "开发中",
    statusStampEn: "In Development",
    statusTelemetry: "DEV // IN PROGRESS",
    link: {
      label: "GitHub Repo ↗",
      labelZh: "查看源码 ↗",
  ...
  },
  {
    ...
    taglineZh: "智能解析多源账单凭据、确定性勾稽对账，加密存储于本地的个人财务证据库。",
    taglineEn: "Local-first financial evidence vault with AI-assisted parsing and deterministic reconciliation.",
    statusCode: "in_development_site_live",
    statusStampZh: "开发中 · 网站已上线",
    statusStampEn: "In Dev · Site Live",
    statusTelemetry: "DEV // SITE LIVE",
    link: {
      label: "Official Site ↗",
      labelZh: "访问网站 ↗",
