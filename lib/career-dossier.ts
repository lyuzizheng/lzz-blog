...
export const TIMELINE_NODES: TimelineNode[] = [
  ...
  },
  {
    ...
    summary: "独立设计在线状态引擎（5分钟心跳TTL缓存门禁），彻底阻断百万级 QPS 广播写放大风暴；联合优化正在输入与已读回执信令链路，将已读时间戳锚定至消息 ID 解决多机房时钟漂移与时序倒置；协同资深工程师落地 SG/US/EU 多机房多主同步与冷启动会话丢失 Bug 修复；常态维护 20+ 个 Go 微服务，入职 1 年即获提拔晋升与 Spot Bonus。",
    impact: [
