...
export const zh: Translations = {
  ...
  home: {
    ...
    tagline: "全栈工程师 · 喜欢拍照",
    heroSubtitle:
      "会写一点点代码 | 喜欢拍照，记录 | 热爱生活，刚刚自己装修了家 | ENFJ-A | 比较Random，我们说走就走 | 永远相信美好的事情即将发生！",
    ...
    films: {
      ...
      projects: "产品",
      records: "周记",
      label: "章节索引 —— 灯箱台上散落的五张底片",
    },
  },
  weeklyRecords: {
    title: "每周记录",
    subtitle: "按时间收录每周留下的生活与工作轨迹。",
    personal: "个人",
    personalDescription: "工作之外的生活记录，由本人单独整理。",
    personalEmpty: "适合公开的个人记录会在准备好后出现在这里。",
    work: "工作",
    workDescription: "由协作、计划与工程记录整理而成的公开版每周工作摘要。",
    agentMaintained: "由智能助手每周更新",
    atAGlance: "本周概览",
    calendarCoverage: "日历统计",
    coverageNote:
      "工作记录同步自公开版 Weekly Record；每周自动更新流程不会修改个人记录。",
  },
  posts: {
