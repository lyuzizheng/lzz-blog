 ...
 * Blogs (/posts) · Career (/career) · Photography (/photography) · Products (/products)
 * · Weekly Records (/weekly-records)
 */
export const CHAPTER_NEGATIVES = [
  { key: "blogs", label: "Blogs", labelZh: "文章", href: "/posts", frameNo: "01" },
  { key: "career", label: "Career", labelZh: "履历", href: "/career", frameNo: "02" },
  ...
  { key: "records", label: "Records", labelZh: "周记", href: "/weekly-records", frameNo: "05" },
] as const;
