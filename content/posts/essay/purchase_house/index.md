...
4. 如果你像我一下，需求和要求比较多：
  ...
  > 所以，我的需求就比较明确了，1000sqf 左右，2005 年后见的HDB，距离 MRT最多5 分钟，不要太偏僻比如NTU，三巴旺，然后如果有 mall 则会更好。

5. 然后这些需求筛选下来，只有很小一部分房子满足需求了，然后看房也比较集中，这个时候，如果你愿意尝试探索，愿意试错，我是鼓励你不用中介去自己尝试购房的。ZZ 就是这样，下面会详细描述踩的坑，各种遇到的困难，但是成功后的满足感也是  满满的。如果你有兴趣可以继续读下去，或许能帮助你剩下上万的中介费～

![image.png](p4.png)

## 如何看房和区分好坏（无中介）

主要从以下几个方面考虑，影响房子是否适合你的点：房型，楼层，周边设施，朝向，噪音，小区的户数，升值空间等等
对于 condo 来说，小区的户数至关重要，小区 facility 的维护是需要屋主共同出维护费的，如果一个单栋占地面积小的 condo，对于设施的丰富程度和维护状态都会来的比一个大的 condo 要差。同时还要考虑到小区目前入住的人数，这时候可以去 property guru 看小区有多少户正在卖，正在出租，这会给你一个大概的人员分布情况。

同时根据正在出售和正在出租的户数，也能给你一个大概的小区升值空间的判断。如果超多人都要卖，是不是有些问题呢？如果这个小区附近马上也有建成的新的 condo 落地，是不是也会对这个小区的价值有一定的影响？总之，对于 condo 来说，小区的户数是一个非常重要的指标，也是一个非常重要的判断点。
