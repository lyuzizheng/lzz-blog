...
check(!homeAtelier.includes("border-t border-current") && !homeAtelier.includes("optical crop reticle"), "avatar optical crop reticle brackets must be removed (founder directive BRAWUKA-86)");
