...
check((records.match(/period: "/g) || []).length === 12, "Work timeline must contain all 12 Confluence weekly records");
check(records.includes('period: "14–20 Sep 2026"'), "timeline must include the latest imported week");
...
console.log("weekly-records OK: fifth chapter film, Personal/Work cross-fade tabs, 12 imported Work entries, bilingual shell, sitemap.");
