...
import { Download, Mail, Rocket, Printer, ArrowUp } from "lucide-react";
 ...
 * 结构化履历条目：NTU 全额卓越奖学金、U-Wave 校园创业（2 万用户 / 4000 DAU）与工程伦理宣言。
 */
      ...
      <div className="border-b border-border-plate/60 pb-3 font-telemetry text-xs uppercase tracking-widest text-muted">
        <div className="flex items-center justify-between">
          <span className="font-semibold text-ink-dominant">
            {isZh ? "05 // 教育与起点 · 新加坡 · 2017–2021" : "05 // NTU & EARLY ROOTS · SINGAPORE · 2017–2021"}
          </span>
      ...
      <div className="border-t border-border-plate/40 pt-3">
        <div className="flex flex-wrap items-center justify-between gap-y-2">
          ...
          {onScrollToTop && (
            ...
            >
              <span>{isZh ? "回至篇首 · 简介" : "TOP: OVERVIEW"}</span>
