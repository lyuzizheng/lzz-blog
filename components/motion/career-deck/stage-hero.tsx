  ...
  return (
    <div className="relative mx-auto flex h-full w-full max-w-2xl lg:max-w-3xl flex-col justify-center px-6 py-8 sm:px-8">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <blockquote className="border-l-2 border-ink-dominant/60 pl-4 font-serif text-xs italic leading-relaxed text-secondary sm:text-sm">
        ...
        <p className="font-body text-xs leading-relaxed text-secondary sm:text-sm">
          {isZh
